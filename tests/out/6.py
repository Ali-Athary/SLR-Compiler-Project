...
class ArxivAnalysis:
    ...
    def analyze(self):
        ...
        markdown_content = [f"# SLR for: Machine Learning in Autonomous Vehicles\n\n"]
...
def main():
    ...
    print("Topic:", "Machine Learning in Autonomous Vehicles")
    ...
    summarizer = OpenAISummarizer(method="textrank", max_length=350)
