...
class ArxivAnalysis:
    ...
    def analyze(self):
        ...
        markdown_content = [f"# SLR for: Technological Innovations in Health\n\n"]
...
def main():
    ...
    print("Topic:", "Technological Innovations in Health")
    ...
    summarizer = AISummarizer(method="gemini", max_length=250)
