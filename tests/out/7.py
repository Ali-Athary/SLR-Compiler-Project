...
class ArxivAnalysis:
    ...
    def analyze(self):
        ...
        markdown_content = [f"# SLR for: Cybersecurity Threats and Solutions\n\n"]
...
def main():
    ...
    print("Topic:", "Cybersecurity Threats and Solutions")
    ...
    summarizer = AISummarizer(method="gpt-4", max_length=250)
